...
PartySim <- function(nGroups = 1, # Value determining the number of groups that should be generated.
                     ...
                     HPmax_Up = rep(250, nGroups), #Vector consisting of the upper range values for HPmax for each group.
                     AC = NA, #Vector consisting of the AC bonus of each group, respectively.
                     AC_Low = rep(8, nGroups), #Vector consisting of the AC bonus of each group, respectively.
