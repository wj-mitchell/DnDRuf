# DEV NOTES:
# MOVE THE CREATION OF THESE VARIABLES TO THE COMBAT SIM
# "Group",  "HP", "Initiative", "EngagedWith", "LifeStatus", "RoundKilled"
...
# Groups, #Vector consisting of the names of the conflicting groups
...
# Add Triple 20s and death saves
# Change status to dead, unconcious, and alive
...
CombatSim <- function(df, #Dataframe generated by FighterSim or mirroring its column structure.
                      Ending = c("Death", "Timed"), #Preset values that will dictate how many rounds the simulation should run. "Death" will run until all members of a group have been terminated. "Timed" will run for a number of rounds you specify in the "nRounds" command.
                      Setting = c("Small Field", "Large Field", "Small Room", "Large Room"), #Preset values that will determine the dimensions of the battle map, which is a three dimensional box with flat sides. Custom map dimensions can be entered using the MapDimensions argument, 
                      Settingouk,yjtmhrngdczDimensions = c(1000, 250, 10000), #Vector consisting of three values that represent the dimensions of the battlefield: Width, Length, and Height. The default is that of a Large Field
